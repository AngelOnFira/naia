...
use naia_shared::{
    BigMapKey, BitReader, BitWriter, EntityProperty, GlobalEntity, HostType, LocalEntityMap, OwnedLocalEntity, RemoteEntity, Serde,
};
...
fn migration_handles_multiple_entities() {
    ...
    let entities = vec![
        (GlobalEntity::from_u64(4001), RemoteEntity::new(401), RemoteEntity::new(451)),
        (GlobalEntity::from_u64(4002), RemoteEntity::new(402), RemoteEntity::new(452)),
        (GlobalEntity::from_u64(4003), RemoteEntity::new(403), RemoteEntity::new(453)),
    ];

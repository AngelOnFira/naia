...
cfg_if::cfg_if! {
    if #[cfg(feature = "transport_udp")] {
        use crate::transport::udp::UdpPacketReceiver as InnerReceiver;
    } else if #[cfg(feature = "transport_quic")] {
        use crate::transport::quic::QuicPacketReceiver as InnerReceiver;
    }
}
